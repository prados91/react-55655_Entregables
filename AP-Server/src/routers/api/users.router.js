...
import { create, read, readOne, update, destroy, readByEmail, updateRole , verifyToken} from "../../controllers/users.controller.js";
...
class UsersRouter extends CustomRouter {
    init() {
        ...
        this.update("/:token", ["USER", "PREM", "ADMIN"], verifyToken);
